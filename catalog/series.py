...
SERIES_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "USCONS": {
        ...
        "id": "USCONS",
        "region": "US",
        "name_bg": "Заети в строителството",
        "name_en": "All Employees, Construction",
        "lens": ["labor", "growth"],
        "peer_group": "sectoral_employment",
        "tags": [],
        "transform": "yoy_pct",
        ...
        "typical_release": "first_friday",
        "revision_prone": True,
        "narrative_hint": "Цикличен сектор, силно чувствителен към лихви и housing цикъл. Често обръща преди headline NFP.",
    },
    "TRUCK_EMP": {
        "source": "fred",
        "id": "CES4348400001",
