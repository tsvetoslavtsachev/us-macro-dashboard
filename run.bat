...
echo   5. Export Claude context (.md за дълбок LLM анализ)
echo   6. Rebuild journal index
echo   7. Run tests
echo   8. Open output folder
echo   9. Git status           (какво си променил след последния commit)
echo.
echo   0. Exit
echo.
set /p choice="Избор: "
...
if "%choice%"=="5" goto EXPORT_CTX
if "%choice%"=="6" goto JOURNAL_IDX
